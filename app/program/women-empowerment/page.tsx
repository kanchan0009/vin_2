...
export default function WomenEducationProgramPage() {
  ...
  const faqs = [
    {
      question: "What does a women’s empowerment volunteer do?",

      answer:
        "A women’s empowerment volunteer supports education, leadership, income generation and rights awareness for women and girls.",
    },

    {
      question: "How to volunteer in women’s empowerment with VIN?",

      answer:
        "You can apply through VIN’s volunteer application process and choose a women’s empowerment placement in Nepal.",
    },

    {
      question:
        "What makes this one of the best women’s empowerment volunteer programs?",

      answer:
        "The program focuses on skills training, confidence-building and community change led by women.",
    },

    {
      question:
        "Are there short-term women’s empowerment volunteer opportunities?",

      answer:
        "Yes, VIN offers both short-term and long-term women’s empowerment placements.",
    },

    {
      question:
        "Can I volunteer in women’s empowerment without prior experience?",

      answer:
        "Yes, we provide training and support to help you work effectively with women’s groups.",
    },

    {
      question:
        "Are there leadership and life skills modules in women’s empowerment programs?",

      answer:
        "Yes, many programs include leadership, entrepreneurship and gender equality training.",
    },

    {
      question: "Do you offer volunteer roles linked to women-led enterprise?",

      answer:
        "Yes, some programs connect women’s empowerment with entrepreneurship and local livelihood projects.",
    },
  ];
    ...
    <main className="w-full bg-white">
      ...
      >
        ...
        <img
          ...
          alt="Women Empowerment Volunteer"
        ...
        <div className="relative z-10 flex items-end justify-center h-full pb-10 px-6">
          <div className="max-w-[850px] text-center">
            ...
            <h1 className="text-white text-[20px] md:text-[30px] leading-[32px] font-medium mb-4">
              ...
              <br />
              Empower Women, Grow Communities
            </h1>

            {/* Description */}

            <p className="text-white/85 text-[14px] leading-[26px] max-w-[700px] mx-auto mb-8">
              Help women gain education, vocational skills and leadership
              confidence through programs that promote gender equality and
            ...
            <div className="space-y-12 mt-10">
                    ...
                    <div className="flex-1">
                      ...
                      {index === 3 && (
                        <ul className="mt-1 ml-5 list-disc space-y-1 text-[15px] leading-[28px] text-[#475467]">
                          ...
                          <li>
                            Gender rights awareness and community partnerships
                          </li>
              ...
              <div className="mb-16 ">
                ...
                <p className="text-gray-600 leading-6 ">
                  Many women in Nepal still face barriers to education, economic
                  opportunity and leadership. Volunteers help create safe
                  spaces, skills training and community programs that boost
                  women’s voice, income and confidence.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "We welcome volunteers who care about gender equality, skills training and women-led change.",
                  },

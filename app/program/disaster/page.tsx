...
export default function WomenEducationProgramPage() {
  ...
  const faqs = [
    {
      question: "What does a disaster risk reduction volunteer do?",

      answer:
        "A disaster risk reduction volunteer helps communities prepare for and recover from floods, earthquakes and landslides.",
    },

    {
      question: "How to volunteer in disaster risk reduction with VIN?",

      answer:
        "You can apply through VIN’s volunteer application process and choose a DRR placement in Nepal.",
    },

    {
      question:
        "What makes this one of the best disaster risk reduction volunteer programs?",

      answer:
        "The program combines preparedness training, early warning systems and community resilience planning.",
    },

    {
      question:
        "Are there short-term disaster risk reduction volunteer opportunities?",

      answer:
        "Yes, VIN offers both short-term and long-term disaster resilience placements.",
    },

    {
      question: "Can I volunteer in DRR without prior emergency experience?",

      answer:
        "Yes, training and mentorship are provided to help you contribute safely and effectively.",
    },

    {
      question:
        "Are there leadership and life skills modules in disaster risk reduction programs?",

      answer:
        "Yes, many placements include community preparedness, leadership and first aid training.",
    },

    {
      question:
        "Do you offer NGO volunteer roles linked to resilience enterprise?",

      answer:
        "Yes, some programs connect disaster readiness with livelihood stability and local recovery projects.",
    },
  ];
    ...
    <main className="w-full bg-white">
      ...
      >
        ...
        <img
          ...
          alt="Disaster Risk Reduction Volunteer"
        ...
        <div className="relative z-10 flex items-end justify-center h-full pb-10 px-6">
          <div className="max-w-[850px] text-center">
            ...
            <h1 className="text-white text-[20px] md:text-[30px] leading-[32px] font-medium mb-4">
              Disaster Risk Reduction Volunteer in Nepal:
              <br />
              Build Resilience, Save Lives
            </h1>

            {/* Description */}

            <p className="text-white/85 text-[14px] leading-[26px] max-w-[700px] mx-auto mb-8">
              Work with communities on emergency preparedness, recovery
              planning, and response training to strengthen resilience before
              and after disasters.
            </p>
            ...
            <div className="space-y-12 mt-10">
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-[16px] leading-[24px] text-[#6E7485]">
                  As a disaster risk reduction volunteer, you’ll help ViN meet
                  these goals:
                </p>
              </div>
                    ...
                    <div className="flex-1">
                      ...
                      {index === 3 && (
                        <ul className="mt-1 ml-5 list-disc space-y-1 text-[15px] leading-[28px] text-[#475467]">
                          ...
                          <li>
                            Emergency coordination and resilience building
                          </li>
              ...
              <div className="mb-16 ">
                <h2 className="text-4xl md:text-[38px]  text-[#1F2432] mb-6">
                  Why Disaster Risk Reduction? Why Nepal?
                </h2>
                ...
                <p className="text-gray-600 leading-6 ">
                  Nepal is highly vulnerable to earthquakes, floods and
                  landslides. Volunteers help communities build preparedness,
                  early warning systems and recovery capacity so they can
                  respond faster and recover stronger.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "We welcome volunteers committed to disaster readiness and community resilience.",
                  },

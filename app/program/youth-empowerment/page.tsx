...
export default function WomenEducationProgramPage() {
  ...
  const faqs = [
    {
      question: "What does a youth empowerment volunteer do?",

      answer:
        "A youth empowerment volunteer supports leadership, education and life skills programs for young people.",
    },

    {
      question: "How to volunteer in youth empowerment with VIN?",

      answer:
        "You can apply through VIN’s volunteer application process and choose a youth empowerment placement in Nepal.",
    },

    {
      question:
        "What makes this one of the best youth empowerment volunteer programs?",

      answer:
        "The program helps young people build leadership, career skills and confidence through community initiatives.",
    },

    {
      question:
        "Are there short-term youth empowerment volunteer opportunities?",

      answer:
        "Yes, VIN offers both short-term and long-term youth development placements.",
    },

    {
      question:
        "Can I volunteer in youth empowerment without prior experience?",

      answer:
        "Yes, training and mentorship are provided to help you work with youth effectively.",
    },

    {
      question:
        "Are there leadership and life skills modules in youth empowerment programs?",

      answer:
        "Yes, many placements include leadership, mentoring and career guidance modules.",
    },

    {
      question: "Do you offer volunteer roles linked to youth enterprise?",

      answer:
        "Yes, some programs connect youth empowerment with entrepreneurship and skills-based livelihoods.",
    },
  ];
    ...
    <main className="w-full bg-white">
      ...
      >
        ...
        <img
          ...
          alt="Youth Empowerment Volunteer"
        ...
        <div className="relative z-10 flex items-end justify-center h-full pb-10 px-6">
          <div className="max-w-[850px] text-center">
            ...
            <p className="text-white/85 text-[14px] leading-[26px] max-w-[700px] mx-auto mb-8">
              Mentor young people through leadership, education and
              skills-building initiatives that help youth shape their future and
            ...
            <div className="space-y-12 mt-10">
              ...
              <div className="mb-16 ">
                <h2 className="text-4xl md:text-[38px]  text-[#1F2432] mb-6">
                  Why Youth Empowerment? Why Nepal?
                </h2>
                ...
                <p className="text-gray-600 leading-6 ">
                  Nepal’s young people are ready to lead but need access to
                  education, job skills and confidence. Volunteers help create
                  youth programs that inspire leadership, employability and
                ...
                {[
                  {
                    ...
                    desc: "We welcome volunteers driven to support young leaders, skills training and youth development.",
                  },

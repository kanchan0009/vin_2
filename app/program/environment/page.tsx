...
export default function WomenEducationProgramPage() {
  ...
  const faqs = [
    {
      question: "What does an environment conservation volunteer do?",

      answer:
        "An environment conservation volunteer helps restore forests, reduce waste and support sustainable land use in Nepal.",
    },

    {
      question: "How to volunteer in environment conservation with VIN?",

      answer:
        "You can apply through VIN’s volunteer application process and choose an environment conservation placement in Nepal.",
    },

    {
      question:
        "What makes this one of the best environment conservation volunteer programs?",

      answer:
        "The program combines hands-on restoration, environmental education and community-led sustainability work.",
    },

    {
      question:
        "Are there short-term environment conservation volunteer opportunities?",

      answer:
        "Yes, VIN offers both short-term and long-term environment conservation placements.",
    },

    {
      question:
        "Can I volunteer in environment conservation without prior experience?",

      answer:
        "Yes, local staff provide training and support so you can contribute effectively.",
    },

    {
      question:
        "Are there leadership and life skills modules in volunteer programs for environmental work?",

      answer:
        "Yes, many placements include community advocacy, project management and sustainability education.",
    },

    {
      question: "Do you offer NGO volunteer roles linked to green enterprise?",

      answer:
        "Yes, some programs connect conservation with green livelihoods and local business skills.",
    },
  ];
    ...
    <main className="w-full bg-white">
      ...
      >
        ...
        <img
          ...
          alt="Environment Conservation Volunteer"
        ...
        <div className="relative z-10 flex items-end justify-center h-full pb-10 px-6">
          <div className="max-w-[850px] text-center">
            ...
            <h1 className="text-white text-[20px] md:text-[30px] leading-[32px] font-medium mb-4">
              ...
              <br />
              Protect Nature, Restore Ecosystems
            </h1>

            {/* Description */}

            <p className="text-white/85 text-[14px] leading-[26px] max-w-[700px] mx-auto mb-8">
              Take part in tree planting, river cleanups and sustainable farming
              projects to preserve Nepal&apos;s landscapes and support greener
              communities.
            </p>
            ...
            <div className="space-y-12 mt-10">
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-[16px] leading-[24px] text-[#6E7485]">
                  As an environment conservation volunteer, you’ll help ViN meet
                  these goals:
                </p>
              </div>
              ...
              {/* Why Environment Conservation */}

              <div className="mb-16 ">
                <h2 className="text-4xl md:text-[38px]  text-[#1F2432] mb-6">
                  Why Environment Conservation? Why Nepal?
                </h2>
                ...
                <p className="text-gray-600 leading-6 ">
                  Nepal’s forests, rivers and mountain ecosystems are under
                  pressure from climate change, pollution and land use.
                  Volunteers help protect biodiversity, restore natural systems
                  and teach sustainable practices that benefit people and
                  nature.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "We welcome volunteers with a passion for protecting Nepal’s environment.",
                  },

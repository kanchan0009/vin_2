...
export default function WomenEducationProgramPage() {
  ...
  const faqs = [
    {
      question: "What does a children’s development volunteer do?",

      answer:
        "A children’s development volunteer supports literacy, health, early childhood learning and mentoring programs for children in rural Nepal.",
    },

    {
      question: "How to volunteer in children’s development with VIN?",

      answer:
        "You can apply through VIN’s volunteer application process and choose a children’s development placement in Nepal.",
    },

    {
      question:
        "What makes this one of the best children’s development volunteer programs?",

      answer:
        "The program blends early childhood education, nutrition, mentoring and community support to create strong, sustainable outcomes for children.",
    },

    {
      question:
        "Are there short-term children’s development volunteer opportunities?",

      answer:
        "Yes, VIN offers both short-term and long-term children’s development placements based on your availability.",
    },

    {
      question:
        "Can I volunteer in children’s development without formal teaching experience?",

      answer:
        "Yes, you will receive training and local support to work effectively with children and caregivers.",
    },

    {
      question:
        "Are there leadership and life skills modules in children’s development programs?",

      answer:
        "Yes, many programs include child mentoring, confidence-building and community education modules.",
    },

    {
      question:
        "Do you offer roles in children’s development linked to local enterprise?",

      answer:
        "Some placements connect child development with family wellbeing and local early education initiatives.",
    },
  ];
    ...
    <main className="w-full bg-white">
      ...
      >
        ...
        <img
          ...
          alt="Children's Development Volunteer"
        ...
        <div className="relative z-10 flex items-end justify-center h-full pb-10 px-6">
          <div className="max-w-[850px] text-center">
            ...
            <h1 className="text-white text-[20px] md:text-[30px] leading-[32px] font-medium mb-4">
              ...
              <br />
              Teach, Mentor, and Transform Young Lives
            </h1>

            {/* Description */}

            <p className="text-white/85 text-[14px] leading-[26px] max-w-[700px] mx-auto mb-8">
              Join our children’s development program to support early literacy,
              mentorship, health and growth for rural children through education
              and community care.
            </p>
            ...
            <div className="space-y-12 mt-10">
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-[16px] leading-[24px] text-[#6E7485]">
                  As a children’s development volunteer, you’ll help ViN meet
                  these goals:
                </p>
              </div>
              ...
              {/* Why Children’s Development */}

              <div className="mb-16 ">
                <h2 className="text-4xl md:text-[38px]  text-[#1F2432] mb-6">
                  Why Children’s Development? Why Nepal?
                </h2>
                ...
                <p className="text-gray-600 leading-6 ">
                  Many children in rural Nepal still lack access to quality
                  early learning, nutrition and safe spaces. Your volunteer
                  support helps build stronger classrooms, better wellbeing and
                ...
                {[
                  {
                    ...
                    desc: "We welcome volunteers of all backgrounds who are enthusiastic about children's development.",
                  },

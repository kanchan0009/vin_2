...
const news = [
  ...
  },
  {
    id: 4,
    image: "/hero.png",
    title: "Community Health Camp Reaches Remote Villages",
    description:
      "A recent health camp provided screenings and medicines across three remote villages.",
  },
  {
    id: 5,
    image: "/hero.png",
    title: "New Classroom Built Through Local Partnership",
    description:
      "Together with local partners, VIN completed a new classroom to support children's learning.",
  },
  {
    id: 6,
    image: "/hero.png",
    title: "Environmental Restoration Project Shows Early Success",
    description:
      "Native tree planting and river clean-up created measurable improvements in local biodiversity.",
  },
];
  ...
  return (
    <section className="w-full py-10 px-4 sm:px-6 lg:px-7 relative overflow-hidden mb-10">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-8">
        ...
        <Link
          href="/media/blogs"
          className="w-fit whitespace-nowrap shrink-0 rounded-md bg-[#1F2B6C] px-6 py-3 text-sm font-medium text-white transition hover:bg-[#3340d0] inline-flex items-center justify-center"
        >
          View all
        </Link>
      </div>
